        ...
        <form method="POST" action="{{ route("admin.agent-plans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('refundable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="refundable" id="refundable" value="1" {{ old('refundable', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="refundable">{{ trans('cruds.agentPlan.fields.refundable') }}</label>
                </div>
