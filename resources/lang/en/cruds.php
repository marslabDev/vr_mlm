...
return [
    ...
    'commissionStatement' => [
        ...
        'title_singular' => 'Commission Statement',
        'fields'         => [
            'id'                      => 'ID',
            'id_helper'               => ' ',
            'agent'                   => 'Agent',
            ...
            'commission_group_helper' => ' ',
        ],
    ],
    'commissionTypeStatement' => [
        'title'          => 'Commission Type Statement',
        'title_singular' => 'Commission Type Statement',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'type'              => 'Type',
