...
class DealerStudentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = DealerStudent::query()->select(sprintf('%s.*', (new DealerStudent())->table));
            ...
            $table->editColumn('actions', function ($row) {
                $viewGate = 'dealer_student_show';
                $editGate = 'dealer_student_edit';
                $deleteGate = 'dealer_student_delete';
                $crudRoutePart = 'dealer-students';
        ...
        return view('admin.dealerStudents.index');
    }
}
